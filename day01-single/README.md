...
* [单例设计模式](#单例设计模式)
  * [1.模式介绍](#1模式介绍)
  * [2.八种方式](#2八种方式)
    * [2.1 饿汉式（静态常量）](#21-饿汉式静态常量)
    * [2.2 饿汉式（静态代码块）](#22-饿汉式静态代码块)
    * [2.3 懒汉式（线程不安全）](#23-懒汉式线程不安全)
    * [2.4 懒汉式（线程安全，同步方法）](#24-懒汉式线程安全同步方法)
    * [2.5 懒汉式（线程安全，同步代码块）](#25-懒汉式线程安全同步代码块)
    * [2.6 双重检查](#26-双重检查)
    * [2.7 静态内部类](#27-静态内部类)
    * [2.8 枚举](#28-枚举)
  * [3.单例模式总结](#3单例模式总结)
  * [4. 单例模式使用场景](#4-单例模式使用场景)
  * [5. 源码体现](#5-源码体现)
    * [5.1 java.lang.Runtime 就是一个饿汉式的单例体现](#51-javalangruntime-就是一个饿汉式的单例体现)
